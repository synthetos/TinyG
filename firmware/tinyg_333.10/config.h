...
#define SR_DEFAULTS 	"line","posx","posy","posz","posa","vel","unit","motm","coor","stat","cycl","mots","hold"
#define DONT_PERSIST	"gc"		// commands that should not be persisted (comma separated)
#define DONT_INITIALIZE "gc,sr"
