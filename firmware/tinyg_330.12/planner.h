...
double mp_get_machine_position(uint8_t axis);
double mp_get_work_position(uint8_t axis);
double mp_get_current_velocity(void);
double mp_get_current_linenum(void);

void mp_queue_program_stop(void);
void mp_queue_program_end(void);

uint8_t mp_plan_hold(void);
