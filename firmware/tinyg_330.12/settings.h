...
#define GCODE_INCH_MODE 	21			// 20=inches, 21=mm
#define GCODE_SELECT_PLANE	17			// 17=XY plane
#define GCODE_PATH_CONTROL 	64			// 64=continuous mode
#define GCODE_ABSOLUTE_MODE 90			// 90=absolute mode, 91=relative mode
