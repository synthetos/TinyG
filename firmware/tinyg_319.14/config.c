...
enum cfgMnemonics { P_, V_,		// <-- profile and version records. Must be first.
	...
	GU, GL, GP, GD, EA, 
	JA, MM, MT, HM, EC, 
	IC, IL, EX, EE,				// 14 general settings (adjust #define COUNT_GENERAL)
...
#define COUNT_GENERAL 14		// <-- this must agree with above
...
static void _appmmCO(struct cfgSetting *s);
...
static void _appinCO(struct cfgSetting *s);
...
char fmmCO[] PROGMEM = "Corner offset     %5.4f mm           $%c%s%1.4f\n";
...
char finCO[] PROGMEM = "Corner offset     %5.4f in           $%c%s%1.4f\n";
...
//char fdgCO[] PROGMEM = "Corner offset     %5.4f deg          $%c%s%1.4f\n";
...
char fmmJA[] PROGMEM = "Jerk corner acceleration   %6.0f mm/min^2     $%s%1.0f\n";
char finJA[] PROGMEM = "Jerk corner acceleration   %6.0f in/min^2     $%s%1.0f\n";
...
struct cfgSetting cfgList[COUNT_SETTINGS] = { 
	...
	{ CFG_X, JM, fmmJM, finJM, _appmmJM, _appinJM, (double) X_JERK_MAX },
	{ CFG_X, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) X_JERK_CORNER_OFFSET },
	...
	{ CFG_Y, JM, fmmJM, finJM, _appmmJM, _appinJM, (double) Y_JERK_MAX },
	{ CFG_Y, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) Y_JERK_CORNER_OFFSET },
	...
	{ CFG_Z, JM, fmmJM, finJM, _appmmJM, _appinJM, (double) Z_JERK_MAX },
	{ CFG_Z, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) Z_JERK_CORNER_OFFSET },
	...
	{ CFG_A, JM, fdgJM, fdgJM, _appdgJM, _appdgJM, (double) A_JERK_MAX },
	{ CFG_A, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) A_JERK_CORNER_OFFSET },
	...
	{ CFG_B, JM, fdgJM, fdgJM, _appdgJM, _appdgJM, (double) B_JERK_MAX },
	{ CFG_B, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) B_JERK_CORNER_OFFSET },
	...
	{ CFG_C, JM, fdgJM, fdgJM, _appdgJM, _appdgJM, (double) C_JERK_MAX },
	{ CFG_C, CO, fmmCO, finCO, _appmmCO, _appinCO, (double) C_JERK_CORNER_OFFSET },
	...
	{ CFG_GENERAL, JA, fmmJA, finJA, _appmmJA, _appinJA, (double) JERK_CORNER_ACCELERATION },
...
static void _appmmJM(struct cfgSetting *s) { cfg.a[s->grp].jerk_max = s->value; }
static void _appmmCO(struct cfgSetting *s) { cfg.a[s->grp].jerk_corner_offset = s->value; }
...
static void _appinCO(struct cfgSetting *s) { s->value *= MM_PER_INCH; _appmmCO(s); }
...
static void _appinMM(struct cfgSetting *s) { s->value *= MM_PER_INCH; _appmmMM(s); }
...
/*
 * cfg_print_config_help() - config help screen - this has been moved to help.c
 */
