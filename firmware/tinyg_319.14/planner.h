...
#define MP_BUFFER_SIZE 24		// line buffer pool (12 min, 255 max)
#define MP_BUFFERS_NEEDED 1		// write buffers needed for aline
...
#define MIN_SEGMENT_USEC 10000	// microseconds - 10 ms. works well
#define MAX_PLANNER_ITERATIONS 50// get_segments() maxi iterations
#define PLANNER_ERROR_PERCENT 0.01 // accuracy as percent - 0.01 = 1%
#define MIN_SEGMENT_SEC (MIN_SEGMENT_USEC/1000000)	// a convenience
#define ONE_MINUTE_OF_MICROSECONDS 60000000
//#define TANGENTIAL_JERK_MINUTES 0.01// time interval for tangential velocity calculation
