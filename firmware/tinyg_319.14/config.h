...
struct cfgStructAxis {
	...
	double jerk_max;		// Jm in mm/min^3
//	double jerk_stall_velocity;// jerk limit at Vi=0
//	double jerk_transition_size;// St in mm - derived from max and stall
	double jerk_corner_offset;
...
struct cfgStructGlobal {
	...
	double jerk_corner_acceleration;
