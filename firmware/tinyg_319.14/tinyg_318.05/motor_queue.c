...
{
	double steps[AXES] = {100, 111, 123, 0, 0, 0 };
	mq_queue_line(steps, 1000000);
}

void _mp_test_short_line() 
{
	double steps[AXES] = {10, 10, 10, 0, 0, 0 };
	mq_queue_line(steps, 10000);
}

void _mp_test_very_short_line() 
{
	double steps[AXES] = {0.10, 0.20, 0.30, 0, 0, 0 };
	mq_queue_line(steps, 10000);
}
