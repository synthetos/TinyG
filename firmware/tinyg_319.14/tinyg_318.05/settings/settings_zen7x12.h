...
#define X_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
#define Y_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
#define Z_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
#define A_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
#define B_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
#define C_JERK_STALL_VELOCITY JERK_STALL_VELOCITY
