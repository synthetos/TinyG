...
enum moveState {
	...
	MOVE_STATE_NEW,			// value if you need an initialization
	MOVE_STATE_ACCEL_1,		// aline() acceleration segment 1
	MOVE_STATE_ACCEL_2,		// aline() acceleration segment 2
	MOVE_STATE_CRUISE,		// aline() cruise segment
	MOVE_STATE_DECEL_0,		// aline() deceleration initialization
	MOVE_STATE_DECEL_1,		// aline() deceleration segment 1
	MOVE_STATE_DECEL_2,		// aline() deceleration segment 2
	MOVE_STATE_RUNNING		// general run state (for non-acceleration moves) 
