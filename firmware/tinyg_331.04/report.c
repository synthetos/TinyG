...
static void _text_csv_status_report();
...
Distance mode:   G90 - absolute distance
Feed rate mode:  G94 - units per minute
Feed Rate:       0.000 mm \ min
Position X:      0.000 mm
Position Y:      0.000 mm
Position Z:      0.000 mm
Position A:      0.000 degrees
Position B:      0.000 degrees
Position C:      0.000 degrees
Offset I:        0.000 mm
Offset J:        0.000 mm
Offset K:        0.000 mm
Machine state:   Reset
...
void rpt_run_status_report()
{
	if (tg.communications_mode == TG_JSON_MODE) {
		...
		_text_csv_status_report();
	}
}

static void _text_csv_status_report() 		// single line status report
{
	INDEX_T i;
	cmdObj cmd;
...
void rpt_json_status_report() 				// JSON status report
{
	INDEX_T i;
