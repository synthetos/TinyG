...
//----- planner hierarchy for gcode and cycles -------------------------//
	DISPATCH(rpt_try_status_report());	// conditionally send status report
...
char msg_stat24[] PROGMEM = "Gcode feedrate error";
char msg_stat25[] PROGMEM = "Gcode input error";
char msg_stat26[] PROGMEM = "Homing cycle failed";
char msg_stat27[] PROGMEM = "Max travel exceeded";
char msg_stat28[] PROGMEM = "Max spindle speed exceeded";
PGM_P msgStatus[] PROGMEM = {	
	...
	msg_stat25, msg_stat26, msg_stat27, msg_stat28
};
...
//	xio_queue_RX_string_usb("$x\n");
//	xio_queue_RX_string_usb("$g61.1=1\n");
//	xio_queue_RX_string_usb("$g17=1\n");
...
//	xio_queue_RX_string_usb("g10 l2 p2 x0 y10 z20\n"); // test G10
...
//	xio_queue_RX_string_usb("{\"sr\":{\"ln\":true,\"gc\":true,\"xwp\":true}}\n"); // set status report
//	xio_queue_RX_string_usb("{\"sr\":\"\"}\n");				// get status report
