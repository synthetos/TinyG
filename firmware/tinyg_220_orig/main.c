...
void tg_app_reset(void) 
{								// Order dependent inits are numbered
...
void _tg_unit_tests(void);		// prototype
void _tg_unit_tests(void) 		// function itself
{
...
int main(void) 
{
	cli();						// Order dependent inits are numbered
	...
	tg_app_reset();				// (7) application reset
	_tg_unit_tests();			// execute any tests
	cfg.kill = FALSE;
