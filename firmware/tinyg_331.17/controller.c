...
char msg_stat25[] PROGMEM = "Gcode feedrate error";
char msg_stat26[] PROGMEM = "Gcode input error";
char msg_stat27[] PROGMEM = "Homing cycle failed";
char msg_stat28[] PROGMEM = "Max travel exceeded";
char msg_stat29[] PROGMEM = "Max spindle speed exceeded";
...
//	xio_queue_RX_string_usb("$g55c=100\n");
