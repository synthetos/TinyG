...
uint8_t cm_homing_cycle()
{
	...
	cm_set_target(cm_set_vector(0,0,0,0,0,0));// it is necessary to...
	cm_set_origin_offsets(cm_set_vector(0,0,0,0,0,0));//...zero the gcode model
	cm_save_gcode_model();					// copy gm to gt
