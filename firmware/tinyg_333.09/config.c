...
static uint8_t _get_cycl(cmdObj *cmd);	// get cycle state as value and string
static uint8_t _get_mots(cmdObj *cmd);	// get motion state as value and string
static uint8_t _get_hold(cmdObj *cmd);	// get hold state as value and string
...
static PGM_P msg_stat[] PROGMEM = { msg_stat0, msg_stat1, msg_stat2, msg_stat3 };

static char msg_cycl0[] PROGMEM = "Off";
static char msg_cycl1[] PROGMEM = "Started";
static char msg_cycl2[] PROGMEM = "Homing";
static char msg_cycl3[] PROGMEM = "Probe";
static PGM_P msg_cycl[] PROGMEM = { msg_cycl0, msg_cycl1, msg_cycl2, msg_cycl3 };

static char msg_mots0[] PROGMEM = "Stop";
static char msg_mots1[] PROGMEM = "Run";
static char msg_mots2[] PROGMEM = "Hold";
static char msg_mots3[] PROGMEM = "Resume";
static PGM_P msg_mots[] PROGMEM = { msg_mots0, msg_mots1, msg_mots2, msg_mots3 };
...
// Action commands
char str_test[] PROGMEM = "test,test,[test] test %d";
...
char str_cycl[] PROGMEM = "cycl,cycl,Cycle state:         %s\n";
...
//	 string *, print func, get func, set func  target for get/set,    default value
	...
	// action commands
	{ str_test,_print_ui8, _get_ui8, tg_test, (double *)&tg.test, 0 },// test number
	...
	{ str_cycl,_print_str, _get_cycl,_set_nul, (double *)&tg.null, 0 },	// cycle state
...
static uint8_t _get_cycl(cmdObj *cmd)
{
	return(_get_msg_helper(cmd, (prog_char_ptr)msg_cycl, cm_get_cycle_state()));
}
...
{
	if ((cmd->index < 0) || (cmd->index >= CMD_INDEX_MAX)) return;
//	char exclude[] = { DONT_PERSIST };			// don't persist these
//	if (strstr(exclude, cmd->token) != NULL) return;
