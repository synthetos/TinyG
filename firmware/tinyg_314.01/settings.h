...
// per-axis values
#define X_AXIS_MODE AXIS_ENABLED
#define Y_AXIS_MODE AXIS_ENABLED
#define Z_AXIS_MODE AXIS_ENABLED
#define A_AXIS_MODE AXIS_CIRCUMFERENCE
#define B_AXIS_MODE AXIS_CIRCUMFERENCE
#define C_AXIS_MODE AXIS_CIRCUMFERENCE

#define X_SEEK_RATE_MAX 800 		// G0 max seek rate in mm/min
#define Y_SEEK_RATE_MAX 800
#define Z_SEEK_RATE_MAX 800
...
#define A_CIRCUMFERENCE 10			// radius in mm
#define B_CIRCUMFERENCE 10			// (XYZ values are not defined)
#define C_CIRCUMFERENCE 10
