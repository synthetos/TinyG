...
#define ANGULAR_JERK_UPPER_THRESHOLD 0.60	// above which it's exact stop
#define ANGULAR_JERK_LOWER_THRESHOLD 0.20	// below which it's continuous
...
/* Axis mode settings (see tinyg.h for defns) */

#define X_AXIS_MODE AXIS_COORDINATED
#define Y_AXIS_MODE AXIS_COORDINATED
#define Z_AXIS_MODE AXIS_COORDINATED
#define A_AXIS_MODE AXIS_COORDINATED
...
#define X_RADIUS 0						// 0 is undefined
#define Y_RADIUS 0
#define Z_RADIUS 0
...
#define A_TRAVEL_PER_REV RADIAN			// degrees moved per motor revolution
...
// per-axis values
#define X_SEEK_RATE 800 				// G0 max seek rate in mm/min
#define Y_SEEK_RATE 800
#define Z_SEEK_RATE 800
#define A_SEEK_RATE 800

#define X_FEED_RATE 800 				// G1 max feed rate in mm/min
#define Y_FEED_RATE 800
#define Z_FEED_RATE 800
#define A_FEED_RATE 800
...
#define A_TRAVEL_PER_REV LEAD_SCREW_PITCH // degrees moved per motor revolution
...
#define X_RADIUS 0						// X, Y and Z values are unused
#define Y_RADIUS 0
#define Z_RADIUS 0
#define A_RADIUS RADIAN// makes mm/min = degrees/min on conversion
