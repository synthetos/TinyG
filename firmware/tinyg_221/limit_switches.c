 ...
 * doing debouncing as an integration as it fires immediately. The 
 * lockout counter is handled by the real-time counter (xmega_rtc.c) 
 * which must in the build.
 */
...
/*
 * ISRs - Limit switch interrupt handler routines
 */
