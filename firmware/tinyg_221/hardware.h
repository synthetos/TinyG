...
// Makerbot settings					// Note: Makerbot POLARITY is [0,0,1,1]
#ifdef __MAKERBOT
...
#define MM_MIN_SEGMENT 0.02				// minimum distance for arcs & acceleration

#define HOMING_MODE 1					// set to 1 for power-on-homing
...
#define X_HOMING_OFFSET HOMING_OFFSET	// offset to zero from minimum travel
#define Y_HOMING_OFFSET HOMING_OFFSET
#define Z_HOMING_OFFSET HOMING_OFFSET
#define A_HOMING_OFFSET HOMING_OFFSET

#define X_HOMING_BACKOFF 5
#define Y_HOMING_BACKOFF 5
#define Z_HOMING_BACKOFF 5
#define A_HOMING_BACKOFF 5
