 ...
 *	- add to _cfg_print_config_record(). extend cfgShow[]
...
int cfg_parse(char *block, uint8_t persist, uint8_t display)
{
	...
	switch (cp.token) {
		...
		// non-axis settings
		case CFG_MM_MIN_SEGMENT:	cfg.mm_min_segment = cp.value; break;
		...
		case CFG_POWER_MODE: 		CFG(cp.axis).power_mode = (uint8_t)cp.value; 
									st_set_power_mode(cp.axis, CFG(cp.axis).power_mode); break;
...
uint8_t _cfg_tokenize_config_record()
{
	...
	switch(cp.record[0]) {
		...
		case 'M':
			switch (cp.record[1]) {
				case 'M': { cp.token = CFG_MM_MIN_SEGMENT; break; }
				default: return(TG_UNRECOGNIZED_COMMAND);
			} return (TG_OK);
...
char cfs08[] PROGMEM = "  Millimeters / min segment   %5.3f";
...
char cfs15[] PROGMEM = "  %c axis - Step angle (deg)   %5.3f";
char cfs16[] PROGMEM = "  %c axis - Microstep mode     %5.0f";
char cfs17[] PROGMEM = "  %c axis - Motor polarity     %5.0f";
char cfs18[] PROGMEM = "  %c axis - Power mgmt mode    %5.0f";
char cfs19[] PROGMEM = "  %c axis - Limit switch mode  %5.0f";

char cfs20[] PROGMEM = "  %c axis - Travel / rev       %5.2f";
char cfs21[] PROGMEM = "  %c axis - Travel maximum     %5.0f";
char cfs22[] PROGMEM = "  %c axis - Travel warning     %5.0f";

char cfs23[] PROGMEM = "  %c axis - Homing enabled     %5.0f";
char cfs24[] PROGMEM = "  %c axis - Homing feed rate   %5.0f";
char cfs25[] PROGMEM = "  %c axis - Homing zero offset %5.0f";
char cfs26[] PROGMEM = "  %c axis - Homing backoff     %5.0f";

char cfs27[] PROGMEM = "Derived: max seek rate, max feed rate (change steps / sec to set)\n";
char cfs28[] PROGMEM = "  %c axis - %7.2f        %7.2f mm/min\n";
char cfs29[] PROGMEM = "  %c axis - %7.2f        %7.2f in/min\n";
char cfs30[] PROGMEM = "  %c axis - %7.2f        %7.2f degrees/min\n";

#define COMPUTED_VALUES 27
...
char cff08[] PROGMEM = "MM%1.3f";	// MM per min segment
...
char cff13[] PROGMEM = "%cSE%1.0f";	// Seek max steps per second
char cff14[] PROGMEM = "%cFE%1.0f";	// Feed max steps per sec
char cff15[] PROGMEM = "%cST%1.3f";	// Step angle (degrees per step)
char cff16[] PROGMEM = "%cMI%1.0f";	// Microstep mode
char cff17[] PROGMEM = "%cPO%1.0f";	// Polarity
char cff18[] PROGMEM = "%cPW%1.0f";	// Power management mode
char cff19[] PROGMEM = "%cLI%1.0f";	// Limit switch mode

char cff20[] PROGMEM = "%cRE%1.3f";	// Travel per revolution (mm, degrees)
char cff21[] PROGMEM = "%cTM%1.0f";	// Travel max (mm)
char cff22[] PROGMEM = "%cTW%1.0f";	// Travel warning

char cff23[] PROGMEM = "%cHE%1.0f";	// Homing enable
char cff24[] PROGMEM = "%cHR%1.0f";	// Homing rate
char cff25[] PROGMEM = "%cHO%1.0f";	// Homing offset (mm)
char cff26[] PROGMEM = "%cHB%1.0f";	// Homing backoff (mm)

char cff27[] PROGMEM = "_T%1.0f";	// trailer token (trailer)
...
PGM_P cfgFmt[] PROGMEM = {	
	...
	cff20, cff21, cff22, cff23, cff24, cff25, cff26, cff27
};
...
void _cfg_write_profile_to_NVM(uint16_t base_addr)
{
	...
	_cfg_write_as_record_to_NVM(base_addr, CFG_MM_MIN_SEGMENT, 0, cfg.mm_min_segment); 
...
void _cfg_load_hardwired_settings()
{
	...
	cfg.mm_min_segment = MM_MIN_SEGMENT;
...
void _cfg_test_write_record()	// (outdated)
{
	...
	_cfg_write_as_record_to_NVM(base_addr, CFG_MM_MIN_SEGMENT, 0, MM_MIN_SEGMENT); 
