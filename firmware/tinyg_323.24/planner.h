...
enum moveState {
	MOVE_STATE_IDLE = 0,	// move inactive (MUST BE ZERO)
	MOVE_STATE_NEW,			// value on initial call
	MOVE_STATE_ACCEL_1,		// acceleration segment 1
	MOVE_STATE_ACCEL_2,		// acceleration segment 2
	MOVE_STATE_CRUISE,		// cruise segment
	MOVE_STATE_DECEL_0,		// deceleration initialization
	MOVE_STATE_DECEL_1,		// deceleration segment 1
	MOVE_STATE_DECEL_2,		// deceleration segment 2
	MOVE_STATE_RUNNING,		// running (for non-acceleration moves) 
	MOVE_STATE_END			// force the move to end (kill)
};
...
void mp_invoke_finalize_run_buffer(void);
