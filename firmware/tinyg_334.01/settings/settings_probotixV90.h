...
#define X_TRAVEL_MAX 175			// travel between switches or crashes
...
#define A_SWITCH_MODE TRUE
#define B_SWITCH_MODE TRUE
#define C_SWITCH_MODE TRUE
...
#define G54_X_OFFSET 0			// G54 is conventionally set to all zeros
