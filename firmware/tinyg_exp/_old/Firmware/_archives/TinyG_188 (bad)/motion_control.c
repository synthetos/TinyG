 ...
 *  Re-organized variables into static structs (local scope)
 *  Added non-blocking line and arc generation behaviors to support multitasking
 */
...
static struct MotionControlArcState ma;
...
/* 
 * mc_go_home() - Perform a homing cycle
 */
