...
void store_setting(int parameter, double value);  // A helper method to set new settings from command line


#define VERSION "x0.01"		// designate an xmega version 
...
#define TIMER_CLOCK_DIV TC_CSEL_DIV8_gc		// timer freq = 4 Mhz
