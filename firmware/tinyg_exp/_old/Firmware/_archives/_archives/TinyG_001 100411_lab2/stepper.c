...
//	if (step_rate_x < (65536 / CLK_MHZ)) {			// short timer - up to 2000 uSec
	if (step_rate_x < (2048)) {			// short timer - up to 2000 uSec
		...
		ax.x.counter = ln->steps_max;	// number of steps to make at this rate
	}
}
