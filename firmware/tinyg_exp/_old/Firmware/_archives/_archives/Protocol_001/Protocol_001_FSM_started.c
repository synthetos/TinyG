...
enum states {listening, startPacket, rxFromNode, endFromNode, rxToNode, endToNode, \
			 rxNextTalker, endNextTalker, rxPacketType, rxTypeValue, endPacketType, \
			 rxPayload, finishPacket, executePacket, ackAppPacket} current_state;


enum events {gotDigit, gotAlpha, gotBang, gotEqual, gotEOS, gotWS, gotUnsup, \
			 gotTO, gotMAX, gotOK, gotERR} new_event;
