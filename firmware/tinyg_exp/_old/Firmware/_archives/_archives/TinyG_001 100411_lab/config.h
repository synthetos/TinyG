...
#define STEP_PULSE_TIME			2			// step pulse width microseconds (delay)
...
/* bit positions used by line buffer and some other routines */

#define X_BIT					0			// general purpose bit position for x axis
#define Y_BIT					1
#define Z_BIT					2
#define A_BIT					3

#define X_DIRECTION_BIT			4			// secondary bit position fo x axis
...
#define TC_CLK_DIV_2 	2					// timer freq =  16 Mhz
#define TC_CLK_DIV_4 	3					// timer freq =   8 Mhz
...
#define X_WHOLE_STEPS_PER_MM (94.488188976378)
#define Y_WHOLE_STEPS_PER_MM (94.488188976378)
#define Z_WHOLE_STEPS_PER_MM (94.488188976378)
#define A_WHOLE_STEPS_PER_MM (94.488188976378)

#define X_STEPS_PER_MM (X_WHOLE_STEPS_PER_MM*MICROSTEPS)
#define Y_STEPS_PER_MM (Y_WHOLE_STEPS_PER_MM*MICROSTEPS)
#define Z_STEPS_PER_MM (Z_WHOLE_STEPS_PER_MM*MICROSTEPS)
#define A_STEPS_PER_MM (Z_WHOLE_STEPS_PER_MM*MICROSTEPS)

#define STEP_PULSE_MICROSECONDS 3
