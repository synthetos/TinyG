...
//	gc.feed_rate = cfg.default_feed_rate/60;
//	gc.seek_rate = cfg.default_seek_rate/60;
	gc.feed_rate = cfg.default_feed_rate;
	gc.seek_rate = cfg.default_seek_rate;
