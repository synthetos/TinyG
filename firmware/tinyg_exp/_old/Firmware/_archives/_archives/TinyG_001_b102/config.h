...
#define X_SEEK_WHOLE_STEPS_PER_SEC 3000	// max whole steps per second for G0 motion
#define Y_SEEK_WHOLE_STEPS_PER_SEC 3000 // (motor parameter)
#define Z_SEEK_WHOLE_STEPS_PER_SEC 3000
#define A_SEEK_WHOLE_STEPS_PER_SEC 3000
