...
//int16_t xio_read_usb(struct fdXIO *fd_ptr, char *buf, int16_t size);
//int16_t xio_write_usb(struct fdXIO *fd_ptr, const char *buf, int16_t size);
...
char xio_getc_usb(struct fdXIO *fd_ptr);
char xio_putc_usb(struct fdXIO *fd_ptr, const char c);
