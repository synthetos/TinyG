...
{
	struct fdXIO *f;						// ptr to our fd structure
	...
	f->xio_getc = (*xio_getc_USART);
	f->xio_putc = (*xio_putc_USART);
...
char xio_getc_USART(struct fdXIO *f)
{
...
char xio_putc_USART(struct fdXIO *f, const char c)
{
