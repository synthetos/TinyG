...
FILE *gcodein;				// pointer to __file struct that is the gcode source
							// will need an extern to get to this - see parsers.c
/*
...
//	gcodein = &dev_usb;		// set gcode input stream
	gcodein = &dev_pgm;		// set gcode input stream
