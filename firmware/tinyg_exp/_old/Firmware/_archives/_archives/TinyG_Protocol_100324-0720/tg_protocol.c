...
void (*const PROGMEM prStateTable [MAX_STATES][MAX_EVENTS]) (void) = {
...
//  uint8_t inChar;
  ...
  inChar = '!';
  prEvent = prCharArray['!'];		// get next character event to process
//  prEvent = prCharArray[inChar];		// get next character event to process
