...
#define GCSTATUS_QUIT 1						// encounters a Quit command
#define GCSTATUS_BAD_NUMBER_FORMAT 2
#define GCSTATUS_EXPECTED_COMMAND_LETTER 3
#define GCSTATUS_UNSUPPORTED_STATEMENT 4
#define GCSTATUS_MOTION_CONTROL_ERROR 5
#define GCSTATUS_FLOATING_POINT_ERROR 6
