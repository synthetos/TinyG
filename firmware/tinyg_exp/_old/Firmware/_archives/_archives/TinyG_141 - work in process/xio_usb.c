...
/* 
 *	declare array of functions for xio_usb_getc()
 */

//const PROGMEM void *getcFuncs[](void) = {
//void *getcFuncs[](void) = {

PGM_VOID_P getcFuncs[] PROGMEM = {

					// dec  hex symbol
		_got_char, 	//	0	00	NUL	(Null char)
...
//	pgm_read_word(&getcFuncs[(int)c]);				// call action procedure
