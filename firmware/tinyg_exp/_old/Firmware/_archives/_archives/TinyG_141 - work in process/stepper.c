...
static volatile int busy; 						// TRUE when st_execute_line running 
...
void st_init()
{
 ...
 /* initialize Y axis */
	...
	ax.y.port->OUT |= MICROSTEP_UNITS_bm;		// set microstep bits to eighth
...
/* initialize Z axis */
	...
	ax.z.port->OUT |= MICROSTEP_UNITS_bm;		// set microstep bits to eighth
...
/* initialize A axis */
	...
	ax.a.port->OUT |= MICROSTEP_UNITS_bm;		// set microstep bits to eighth
