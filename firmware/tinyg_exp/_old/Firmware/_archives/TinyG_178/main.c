 ...
 *
 * Modules adapted from Simen Svale Skogsrud's Grbl code retain his copyright.
 * New or completely re-written modules carry new copyrights.
 *
...
int main(void) 
{
	...
	// pre-load the USB input buffer (stdin) with some test strings
	// be careful of the 16 char limit on the RX (circular) buffer.
//	xio_usb_queue_RX_string("?\n");
//	xio_usb_queue_RX_string("f\n");
//	xio_usb_queue_RX_string("G92.1\n");
	xio_usb_queue_RX_string("G2 f320 x0 y0 r50\n");
