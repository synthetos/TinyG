...
{
	printf_P(PSTR("*** GCODE Help ***\n\
You are  in GCODE mode as you can see by the prompt\n\
- Estop is '$'\n\
- To pause motion hit '!'\n\
- To resume motion hit '@'\n\
- To see position and gcode model state hit '?'\n\
- To exit to IDLE mode hit 'q'\n\
