...
#define PREFIX_GROUPS	"x,y,z,a,b,c,1,2,3,4,g54,g55,g56,g57,g58,g59"
...
struct cmdObject {					// depending on use, not all elements may be populated
	...
	char string[CMD_STRING_LEN+1];	// value string (if applicable)
...
//	double coord_offset[COORDS+1];	// coordinate offsets: machine + G54,G55,G56,G57,G58,G59
};
