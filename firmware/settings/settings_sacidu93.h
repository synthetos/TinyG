...
#define X_FEEDRATE_MAX 600				// xfr 		G1 max feed rate in mm/min
#define X_VELOCITY_MAX 600 			// xvm
...
#define C_FEEDRATE_MAX 3600
#define C_VELOCITY_MAX 3600
#define C_TRAVEL_MAX -1
#define C_JERK_MAX 50000000
