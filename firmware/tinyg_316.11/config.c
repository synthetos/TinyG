...
enum cfgMnemonics { P_, V_,		// <-- profile and version records
	...
	JL, JR, JT, JB, MM, 
	MT, HM, EC, IC, IL, 
	EX, EE,						// 17 general settings (adjust #define)
...
struct cfgSetting cfgList[COUNT_SETTINGS] = { 
	...
	{ CFG_GENERAL, JR, fmtJR, fmtJR, _applyJR, _applyJR, (double) MAX_ROTARY_JERK },
	{ CFG_GENERAL, JT, fmtJT, fmtJT, _applyJT, _applyJT, (double) CORNER_JERK_UPPER_THRESHOLD },
	{ CFG_GENERAL, JB, fmtJB, fmtJB, _applyJB, _applyJB, (double) CORNER_JERK_LOWER_THRESHOLD },
	{ CFG_GENERAL, MM, fmmMM, finMM, _appmmMM, _appinMM, (double) MIN_SEGMENT_LENGTH },
	{ CFG_GENERAL, MT, fmtMT, fmtMT, _applyMT, _applyMT, (double) MIN_SEGMENT_TIME },
	{ CFG_GENERAL, HM, fmtHM, fmtHM, _applyHM, _applyHM, (double) HOMING_MODE },

	{ CFG_GENERAL, EC, fmtEC, fmtEC, _applyEC, _applyEC, (double) FALSE },
	{ CFG_GENERAL, IC, fmtIC, fmtIC, _applyIC, _applyIC, (double) FALSE },
	{ CFG_GENERAL, IL, fmtIL, fmtIL, _applyIL, _applyIL, (double) FALSE },
	{ CFG_GENERAL, EX, fmtEX, fmtEX, _applyEX, _applyEX, (double) TRUE },
	{ CFG_GENERAL, EE, fmtEE, fmtEE, _applyEE, _applyEE, (double) TRUE },
