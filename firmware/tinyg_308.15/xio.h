...
#define XIO_XOFF 		(1<<12)			// enable XON/OFF flow control
#define XIO_NOXOFF 		(1<<13)			// disable XON/XOFF flow control
#define XIO_LINEMODE	(1<<14)			// special <cr><lf> read handling
#define XIO_NOLINEMODE	(1<<15)			// no special <cr><lf> read handling
...
#define XIO_FLAG_ECHO_bm 	(1<<3)		// echo received chars to stderr
#define XIO_FLAG_CRLF_bm 	(1<<4)		// convert <LF> to <CR><LF> on WR
#define XIO_FLAG_XOFF_bm 	(1<<5)		// XOFF flow control enabled
