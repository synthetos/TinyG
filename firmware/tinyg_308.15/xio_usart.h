...
int xio_cntrl_rs485(const uint16_t control);	// set control flags w/validation
...
int xio_cntrl_usb(const uint16_t control);		// set control flags w/validation
...
//	volatile uint8_t rx_buf_tail;	// RX buffer read index
	uint8_t rx_buf_tail;	// RX buffer read index
...
//	volatile uint8_t tx_buf_head;	// TX buffer write index
	uint8_t tx_buf_head;	// TX buffer write index
	uint8_t next_tx_buf_head;		// next TX buffer write index
	uint8_t rx_buf_count;			// count of characters in RX buffer
