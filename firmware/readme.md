...
See the Synthetos website and github for more details.
...
MINOR FEATUIRES IN 0.93
* Configurable status reports added
...
BUG FIXES IN 0.93
* Issues #5, #7 and #12 - Issues were found and fixed that affected positional accuracy with some combinations of settings
* Issue #10 - Help display error fixed
* Issue #8 - $xTR did not update until reset
* Fixed some typos in command strings

If you have featrue requests or find any bugs please log them in the Issues tab on the github
