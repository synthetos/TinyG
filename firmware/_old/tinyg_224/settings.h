...
#define MAX_ANGULAR_JERK 100000000	// 100,000,000 mm/(min^3)
//#define MIN_SEGMENT_TIME 2000		// microseconds
#define MIN_SEGMENT_TIME 10000		// microseconds - seems to work best
...
#define GCODE_PATH_CONTROL PATH_CONTROL_MODE_CONTINUOUS
