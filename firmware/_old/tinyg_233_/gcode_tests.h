...
/* board tests */
const char PROGMEM board_test01[] = "\
G0 G17 G21 G40 G49 G80 G90 (initialize modes)\n\
g92x0y0z0a0\n\
(-----G0 tests-----)\n\
()\n\
( Test all axes)\n\
()\n\
G0 x25 y25 z25 a25 (G0 all axes)\n\
...
a12\n\
()\n\
( Test one rev - assumes 1.8 degree motors)\n\
()\n\
g92x0y0z0a0\n\
g1 f100 x2.54\n\
x0\n\
...
g92x0y0z0a0\n\
G4 P1\n\
G1 F100 x3 y3 z3 a3 (F100 all axes)\n\
g92x0y0z0a0\n\
G4 P1\n\
G1 F200 x6 y6 z6 a6 (F200 all axes)\n\
g92x0y0z0a0\n\
G4 P1\n\
G1 F400 x12 y12 z12 a12 (F400 all axes)\n\
g92x0y0z0a0\n\
G4 P1\n\
G1 F600 x20 y20 z20 a20 (F600 all axes)\n\
g92x0y0z0a0\n\
G4 P1\n\
G1 F800 x20 y20 z20 a20 (F800 all axes)\n\
g92x0y0z0a0\n\
G4 P1\n\
G1 F10000 x20 y20 z20 a20 (max all axes)\n\
g92x0y0z0a0\n\
()\n\
(-----Arc tests-----)\n\
()\n\
