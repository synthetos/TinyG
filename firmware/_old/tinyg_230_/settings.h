...
//#define MAX_LINEAR_JERK 10000000	//  10,000,000 mm/(min^3)
...
#define GCODE_PATH_CONTROL PATH_CONTINUOUS	// PATH_EXACT_PATH   PATH_EXACT_STOP
#define GCODE_TOOL 1
...
#define X_TRAVEL 1600				// total travel in X in mm
#define Y_TRAVEL 1600
#define Z_TRAVEL 1600
#define A_TRAVEL 1600
...
// Xmas display profile
#ifdef __XMAS
#define SEEK_STEPS 500
#define FEED_STEPS 500
#define TRAVEL_PER_REV 3			// 1 unit = 1 foot
#define HOMING_OFFSET -50
#define POWER_MODE 1
#define POLARITY 1					// 1 is inverted
#endif
...
#define POWER_MODE 1
#define POLARITY 0					// 1 is inverted
#endif
...
#define HOMING_OFFSET -50
#define POWER_MODE 1
#define POLARITY 0			// Note: POLARITY should be set to [0,0,1,1]
#endif
...
#define X_POLARITY POLARITY				// 0=normal, 1=inverted
#define Y_POLARITY POLARITY
#define Z_POLARITY POLARITY
#define A_POLARITY POLARITY

#define X_POWER_MODE POWER_MODE			// 1=low power idle enabled 
#define Y_POWER_MODE POWER_MODE			// (robot parameter)
#define Z_POWER_MODE POWER_MODE
#define A_POWER_MODE POWER_MODE
...
#define Y_TRAVEL_PER_REV TRAVEL_PER_REV
#define Z_TRAVEL_PER_REV TRAVEL_PER_REV
#define A_TRAVEL_PER_REV TRAVEL_PER_REV
//#define Y_TRAVEL_PER_REV (TRAVEL_PER_REV /1.8)	// (robot parameter)
//#define Z_TRAVEL_PER_REV (TRAVEL_PER_REV /1.8)
//#define A_TRAVEL_PER_REV (TRAVEL_PER_REV /1.8)	// degrees moved per motor revolution
...
#define A_TRAVEL_WARN A_TRAVEL			// -1 is no limit (typ for rotary axis)
