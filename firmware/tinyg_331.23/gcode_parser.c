...
//#define EXEC_FUNC(f,v) if((int)gf.v != 0) { if ((status = f(gn.v)) != TG_OK) { return(status); } }
/* Derived from::
		...
		switch(letter) {
			case 'G':
				switch((uint8_t)value) {
					case 0:  SET_MODAL (MODAL_GROUP_1, motion_mode, MOTION_MODE_STRAIGHT_TRAVERSE);
					case 1:  SET_MODAL (MODAL_GROUP_1, motion_mode, MOTION_MODE_STRAIGHT_FEED);
					case 2:  SET_MODAL (MODAL_GROUP_1, motion_mode, MOTION_MODE_CW_ARC);
					case 3:  SET_MODAL (MODAL_GROUP_1, motion_mode, MOTION_MODE_CCW_ARC);
					case 4:  SET_MODAL (MODAL_GROUP_N, next_action, NEXT_ACTION_DWELL);
					case 10: SET_MODAL (MODAL_GROUP_0, next_action, NEXT_ACTION_SET_COORD_DATA);
					case 17: SET_MODAL (MODAL_GROUP_2, select_plane, CANON_PLANE_XY);
					case 18: SET_MODAL (MODAL_GROUP_2, select_plane, CANON_PLANE_XZ);
					case 19: SET_MODAL (MODAL_GROUP_2, select_plane, CANON_PLANE_YZ);
					case 20: SET_MODAL (MODAL_GROUP_6, units_mode, INCHES);
					case 21: SET_MODAL (MODAL_GROUP_6, units_mode, MILLIMETERS);
					case 28: {
						switch (_point(value)) {
							case 0: SET_MODAL (MODAL_GROUP_0, next_action, NEXT_ACTION_GO_HOME);
							case 1: SET_MODAL (MODAL_GROUP_0, next_action, NEXT_ACTION_SEARCH_HOME); 
					...
					case 54: SET_MODAL (MODAL_GROUP_12, coord_system, G54);
					case 55: SET_MODAL (MODAL_GROUP_12, coord_system, G55);
					case 56: SET_MODAL (MODAL_GROUP_12, coord_system, G56);
					case 57: SET_MODAL (MODAL_GROUP_12, coord_system, G57);
					case 58: SET_MODAL (MODAL_GROUP_12, coord_system, G58);
					case 59: SET_MODAL (MODAL_GROUP_12, coord_system, G59);
					case 61: {
						switch (_point(value)) {
							case 0: SET_MODAL (MODAL_GROUP_12, path_control, PATH_EXACT_PATH);
							case 1: SET_MODAL (MODAL_GROUP_12, path_control, PATH_EXACT_STOP); 
							default: status = TG_UNRECOGNIZED_COMMAND;
						}
						break;
					}
					case 64: SET_MODAL (MODAL_GROUP_12,path_control, PATH_CONTINUOUS);
					case 80: SET_MODAL (MODAL_GROUP_1, motion_mode, MOTION_MODE_CANCEL_MOTION_MODE);
					case 90: SET_MODAL (MODAL_GROUP_3, distance_mode, ABSOLUTE_MODE);
					case 91: SET_MODAL (MODAL_GROUP_3, distance_mode, INCREMENTAL_MODE);
					case 92: {
						switch (_point(value)) {
							case 0: SET_MODAL (MODAL_GROUP_0, next_action, NEXT_ACTION_SET_ORIGIN_OFFSETS);
							case 1: SET_MODAL (MODAL_GROUP_0, next_action, NEXT_ACTION_RESET_ORIGIN_OFFSETS);
					...
					case 93: SET_MODAL (MODAL_GROUP_5, inverse_feed_rate_mode, true);
					case 94: SET_MODAL (MODAL_GROUP_5, inverse_feed_rate_mode, false);
					default: status = TG_UNRECOGNIZED_COMMAND;
				}
				break;
			...
			case 'M':
				switch((uint8_t)value) {
					case 0: case 1: 
							SET_MODAL (MODAL_GROUP_4, program_flow, PROGRAM_FLOW_PAUSED);
					case 2: case 30: case 60:
							SET_MODAL (MODAL_GROUP_4, program_flow, PROGRAM_FLOW_COMPLETED);
					case 3: SET_MODAL (MODAL_GROUP_7, spindle_mode, SPINDLE_CW);
					case 4: SET_MODAL (MODAL_GROUP_7, spindle_mode, SPINDLE_CCW);
					case 5: SET_MODAL (MODAL_GROUP_7, spindle_mode, SPINDLE_OFF);
...
static uint8_t _check_gcode_block()
{
	...
	if ((gp.modals[MODAL_GROUP_0] == true) && (gp.modals[MODAL_GROUP_1] == true)) {
