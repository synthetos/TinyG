 ...
 */
enum cmModalGroup {
	MODAL_GROUP_N = 0,				// Non modal
	MODAL_GROUP_0, 					// [G10,G28,G28.1,G92] Non-modal axis commands
	...
	MODAL_GROUP_13					// [G61,G61.1,G64] Path control mode
};
#define MODAL_GROUP_COUNT MODAL_GROUP_13
