...
uint8_t cm_set_origin_offsets(double x, double y, 		// G92
							  double z, double a);
...
uint8_t cm_straight_traverse(double x, double y, 		// G0
							 double z, double a);
...
uint8_t cm_straight_feed(double x, double y, 			// G1
						 double z, double a); 
...
uint8_t cm_return_to_home_continue(void);

uint8_t cm_arc_feed(double x, double y,					// G2, G3 
					double z, double a,
