 ...
 *
 * This code a refactored version of the grbl gcode interpreter by 
 * Simen Svale Skogsrud. This interpreter attempts to follow the 
 * NIST RS274/NGC specification as closely as possible with regard to 
 * order of operations and other behaviors.
 *
