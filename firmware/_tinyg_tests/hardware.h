 ...
 *			 	Reflects system hardware and is used by multiple modules
...
/* EEPROM data version. Used to migrate old data during firmware upgrades */

#define CONFIG_VERSION 100				// started at 100


/* CPU clock */	

#undef F_CPU							// set for delays
#define F_CPU 32000000UL				// should precede <avr/delay.h>
