...
#define X_TRAVEL_REVOLUTION 2.54		// 10 TPI leadscrew machine
#define Y_TRAVEL_REVOLUTION 2.54		// (robot parameter)
#define Z_TRAVEL_REVOLUTION 2.54
#define A_TRAVEL_REVOLUTION 1.00		// degrees moved per motor revolution
/*
#define X_TRAVEL_REVOLUTION 1.27		// 1/4 - 20 lead screw (0.050" per rev)
#define Y_TRAVEL_REVOLUTION 1.27		// (robot parameter)
