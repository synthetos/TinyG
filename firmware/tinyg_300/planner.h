 ...
 */
#define MP_BUFFER_SIZE 8		// sub-move buffer pool (255 max)
#define MP_BUFFERS_NEEDED 4		// worst case write buffers needed for aline
...
struct mpBuffer * mp_get_prev_buffer(void);
