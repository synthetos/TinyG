...
#define RX_BUFFER_REQUESTED_SIZE 256        // minimum requested buffer size (they are usually larger)
#define RX_BUFFER_POOL_SIZE     2500        // total size of RX buffer memory pool
