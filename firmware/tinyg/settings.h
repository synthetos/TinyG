...
#define MOTOR_POWER_LEVEL			0.25					// default motor power level 0-100 (ARM only)
...
#define JSON_VERBOSITY				JV_SILENT				// one of: JV_SILENT, JV_FOOTER, JV_MESSAGES, JV_CONFIGS, JV_LINENUM, JV_VERBOSE
//#define JSON_VERBOSITY				JV_MESSAGES				// one of: JV_SILENT, JV_FOOTER, JV_MESSAGES, JV_CONFIGS, JV_LINENUM, JV_VERBOSE
...
#define STATUS_REPORT_DEFAULTS		"line","posx","posy","posz","posa","feed","vel","unit","coor","dist","path","frmo","momo","stat"
