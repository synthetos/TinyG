/*
 * settings_probotix.h - Settings for testing with tgfx - build 2404
...
#define INIT_MESSAGE "Initializing configs to tgfx test settings (w/ Fireball V90 profile)"
...
#undef	COM_EXPAND_CR
#define COM_EXPAND_CR			0

#undef	COM_ENABLE_ECHO
#define COM_ENABLE_ECHO			0
