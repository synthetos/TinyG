...
#define INIT_MESSAGE "sparkcrafter JSON settings (from 3/25 3:00 AM post)"

#define JUNCTION_ACCELERATION	200000		// 200,000
...
#define TEXT_VERBOSITY				TV_SILENT
...
#undef	SR_DEFAULTS
#define SR_DEFAULTS "line","posx","posy","posz","mpox","mpoy","mpoz","feed","vel","unit","coor","dist","frmo","momo","stat"
