...
//	{ "",   "tick",_f0, 0, tx_print_int,  get_int,     set_int32,(uint32_t *)&rtc.sys_ticks, 0 },	// tick count
	...
	{ "hom","homx",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_X], false },	// X homed - Homing status group
	{ "hom","homy",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_Y], false },	// Y homed
	{ "hom","homz",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_Z], false },	// Z homed
	{ "hom","homa",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_A], false },	// A homed
	{ "hom","homb",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_B], false },	// B homed
	{ "hom","homc",_f0, 0, cm_print_pos, get_ui8, set_nul,(uint32_t *)&cm.homed[AXIS_C], false },	// C homed
...
//	{ "a","asx",_fip,  0, cm_print_sx, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[AXIS_A][SW_MAX].mode,	A_SWITCH_MODE_MAX },	// new style
	...
	{ "g54","g54a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G54][AXIS_A], G54_A_OFFSET },
	{ "g54","g54b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G54][AXIS_B], G54_B_OFFSET },
	{ "g54","g54c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G54][AXIS_C], G54_C_OFFSET },
	...
	{ "g55","g55a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G55][AXIS_A], G55_A_OFFSET },
	{ "g55","g55b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G55][AXIS_B], G55_B_OFFSET },
	{ "g55","g55c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G55][AXIS_C], G55_C_OFFSET },
	...
	{ "g56","g56a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G56][AXIS_A], G56_A_OFFSET },
	{ "g56","g56b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G56][AXIS_B], G56_B_OFFSET },
	{ "g56","g56c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G56][AXIS_C], G56_C_OFFSET },
	...
	{ "g57","g57a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G57][AXIS_A], G57_A_OFFSET },
	{ "g57","g57b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G57][AXIS_B], G57_B_OFFSET },
	{ "g57","g57c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G57][AXIS_C], G57_C_OFFSET },
	...
	{ "g58","g58a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G58][AXIS_A], G58_A_OFFSET },
	{ "g58","g58b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G58][AXIS_B], G58_B_OFFSET },
	{ "g58","g58c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G58][AXIS_C], G58_C_OFFSET },
	...
	{ "g59","g59a",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G59][AXIS_A], G59_A_OFFSET },
	{ "g59","g59b",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G59][AXIS_B], G59_B_OFFSET },
	{ "g59","g59c",_fipc, 3, cm_print_cofs, get_flt, set_flu,(uint32_t *)&cm.offset[G59][AXIS_C], G59_C_OFFSET },
