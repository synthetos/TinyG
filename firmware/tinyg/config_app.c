...
//	{ "sys", "hp", _f07, 0, fmt_hp, hw_print_hp, get_flt, set_flt, (float *)&cs.hw_platform,TINYG_HARDWARE_PLATFORM },
	{ "sys", "hv", _f07, 0, fmt_hv, hw_print_hv, get_flt, hw_set_hv,  (float *)&cs.hw_version, TINYG_HARDWARE_VERSION },
	{ "sys", "id", _fns, 0, fmt_id, hw_print_id, hw_get_id,  set_nul, (float *)&cs.null, 0 },		// device ID (ASCII signature)
	...
	{ "",   "n",   _fin, 0, fmt_line, cm_print_line, cm_get_line, set_int,(float *)&gm.linenum,0 },	// Gcode line number - gets model or runtime line number
	{ "",   "line",_fin, 0, fmt_line, cm_print_line, cm_get_line, set_int,(float *)&gm.linenum,0 },	// Gcode line number - gets model or runtime line number
...
//	{ "", "sx",  _f00, 0, fmt_nul, tx_print_nul, run_sx,  run_sx , (float *)&cs.null, 0 },					// send XOFF, XON test
	...
	// Motor parameters
	{ "1","1ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_1].motor_map,	M1_MOTOR_MAP },
	{ "1","1sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_1].step_angle,	M1_STEP_ANGLE },
	{ "1","1tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_1].travel_rev,	M1_TRAVEL_PER_REV },
	{ "1","1mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_1].microsteps,	M1_MICROSTEPS },
	{ "1","1po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_1].polarity,		M1_POLARITY },
	{ "1","1pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_1].power_mode,	M1_POWER_MODE },
#if (MOTORS >= 2)
	{ "2","2ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_2].motor_map,	M2_MOTOR_MAP },
	{ "2","2sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_2].step_angle,	M2_STEP_ANGLE },
	{ "2","2tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_2].travel_rev,	M2_TRAVEL_PER_REV },
	{ "2","2mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_2].microsteps,	M2_MICROSTEPS },
	{ "2","2po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_2].polarity,		M2_POLARITY },
	{ "2","2pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_2].power_mode,	M2_POWER_MODE },
#endif
#if (MOTORS >= 3)
	{ "3","3ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_3].motor_map,	M3_MOTOR_MAP },
	{ "3","3sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_3].step_angle,	M3_STEP_ANGLE },
	{ "3","3tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_3].travel_rev,	M3_TRAVEL_PER_REV },
	{ "3","3mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_3].microsteps,	M3_MICROSTEPS },
	{ "3","3po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_3].polarity,		M3_POLARITY },
	{ "3","3pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_3].power_mode,	M3_POWER_MODE },
#endif
#if (MOTORS >= 4)
	{ "4","4ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_4].motor_map,	M4_MOTOR_MAP },
	{ "4","4sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_4].step_angle,	M4_STEP_ANGLE },
	{ "4","4tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_4].travel_rev,	M4_TRAVEL_PER_REV },
	{ "4","4mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_4].microsteps,	M4_MICROSTEPS },
	{ "4","4po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_4].polarity,		M4_POLARITY },
	{ "4","4pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_4].power_mode,	M4_POWER_MODE },
#endif
#if (MOTORS >= 5)
	{ "5","5ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_5].motor_map,	M5_MOTOR_MAP },
	{ "5","5sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_5].step_angle,	M5_STEP_ANGLE },
	{ "5","5tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_5].travel_rev,	M5_TRAVEL_PER_REV },
	{ "5","5mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_5].microsteps,	M5_MICROSTEPS },
	{ "5","5po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_5].polarity,		M5_POLARITY },
	{ "5","5pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_5].power_mode,	M5_POWER_MODE },
#endif
#if (MOTORS >= 6)
	{ "6","6ma",_fip, 0, fmt_0ma, st_print_ma, get_ui8, set_ui8,(float *)&st.m[MOTOR_6].motor_map,	M6_MOTOR_MAP },
	{ "6","6sa",_fip, 2, fmt_0sa, st_print_sa, get_flt, st_set_sa, (float *)&st.m[MOTOR_6].step_angle,	M6_STEP_ANGLE },
	{ "6","6tr",_fip, 3, fmt_0tr, st_print_tr, get_flu, st_set_tr, (float *)&st.m[MOTOR_6].travel_rev,	M6_TRAVEL_PER_REV },
	{ "6","6mi",_fip, 0, fmt_0mi, st_print_mi, get_ui8, st_set_mi, (float *)&st.m[MOTOR_6].microsteps,	M6_MICROSTEPS },
	{ "6","6po",_fip, 0, fmt_0po, st_print_po, get_ui8, set_01, (float *)&st.m[MOTOR_6].polarity,		M6_POLARITY },
	{ "6","6pm",_fip, 0, fmt_0pm, st_print_pm, get_ui8, st_set_pm, (float *)&st.m[MOTOR_6].power_mode,	M6_POWER_MODE },
#endif

	// Axis parameters
	{ "x","xam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_X].axis_mode,	X_AXIS_MODE },
	{ "x","xvm",_fip, 0, fmt_Xvm, cm_print_vm, get_flu, set_flu,(float *)&cm.a[AXIS_X].velocity_max,	X_VELOCITY_MAX },
	{ "x","xfr",_fip, 0, fmt_Xfr, cm_print_fr, get_flu, set_flu,(float *)&cm.a[AXIS_X].feedrate_max,	X_FEEDRATE_MAX },
	{ "x","xtm",_fip, 0, fmt_Xtm, cm_print_tm, get_flu, set_flu,(float *)&cm.a[AXIS_X].travel_max,		X_TRAVEL_MAX },
	{ "x","xjm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_X].jerk_max,	X_JERK_MAX },
	{ "x","xjh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_X].jerk_homing,X_JERK_HOMING },
	{ "x","xjd",_fip, 4, fmt_Xjd, cm_print_jd, get_flu, set_flu,(float *)&cm.a[AXIS_X].junction_dev,	X_JUNCTION_DEVIATION },
	{ "x","xsn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[0],				X_SWITCH_MODE_MIN },
	{ "x","xsx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[1],				X_SWITCH_MODE_MAX },
	{ "x","xsv",_fip, 0, fmt_Xsv, cm_print_sv, get_flu, set_flu,(float *)&cm.a[AXIS_X].search_velocity,	X_SEARCH_VELOCITY },
	{ "x","xlv",_fip, 0, fmt_Xlv, cm_print_lv, get_flu, set_flu,(float *)&cm.a[AXIS_X].latch_velocity,	X_LATCH_VELOCITY },
	{ "x","xlb",_fip, 3, fmt_Xlb, cm_print_lb, get_flu, set_flu,(float *)&cm.a[AXIS_X].latch_backoff,	X_LATCH_BACKOFF },
	{ "x","xzb",_fip, 3, fmt_Xzb, cm_print_zb, get_flu, set_flu,(float *)&cm.a[AXIS_X].zero_backoff,	X_ZERO_BACKOFF },

	{ "y","yam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_Y].axis_mode,	Y_AXIS_MODE },
	{ "y","yvm",_fip, 0, fmt_Xvm, cm_print_vm, get_flu, set_flu,(float *)&cm.a[AXIS_Y].velocity_max,	Y_VELOCITY_MAX },
	{ "y","yfr",_fip, 0, fmt_Xfr, cm_print_fr, get_flu, set_flu,(float *)&cm.a[AXIS_Y].feedrate_max,	Y_FEEDRATE_MAX },
	{ "y","ytm",_fip, 0, fmt_Xtm, cm_print_tm, get_flu, set_flu,(float *)&cm.a[AXIS_Y].travel_max,		Y_TRAVEL_MAX },
	{ "y","yjm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_Y].jerk_max,	Y_JERK_MAX },
	{ "y","yjh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_Y].jerk_homing,Y_JERK_HOMING },
	{ "y","yjd",_fip, 4, fmt_Xjd, cm_print_jd, get_flu, set_flu,(float *)&cm.a[AXIS_Y].junction_dev,	Y_JUNCTION_DEVIATION },
	{ "y","ysn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[2],				Y_SWITCH_MODE_MIN },
	{ "y","ysx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[3],				Y_SWITCH_MODE_MAX },
	{ "y","ysv",_fip, 0, fmt_Xsv, cm_print_sv, get_flu, set_flu,(float *)&cm.a[AXIS_Y].search_velocity,	Y_SEARCH_VELOCITY },
	{ "y","ylv",_fip, 0, fmt_Xlv, cm_print_lv, get_flu, set_flu,(float *)&cm.a[AXIS_Y].latch_velocity,	Y_LATCH_VELOCITY },
	{ "y","ylb",_fip, 3, fmt_Xlb, cm_print_lb, get_flu, set_flu,(float *)&cm.a[AXIS_Y].latch_backoff,	Y_LATCH_BACKOFF },
	{ "y","yzb",_fip, 3, fmt_Xzb, cm_print_zb, get_flu, set_flu,(float *)&cm.a[AXIS_Y].zero_backoff,	Y_ZERO_BACKOFF },

	{ "z","zam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_Z].axis_mode,	Z_AXIS_MODE },
	{ "z","zvm",_fip, 0, fmt_Xvm, cm_print_vm, get_flu, set_flu,(float *)&cm.a[AXIS_Z].velocity_max,	Z_VELOCITY_MAX },
	{ "z","zfr",_fip, 0, fmt_Xfr, cm_print_fr, get_flu, set_flu,(float *)&cm.a[AXIS_Z].feedrate_max,	Z_FEEDRATE_MAX },
	{ "z","ztm",_fip, 0, fmt_Xtm, cm_print_tm, get_flu, set_flu,(float *)&cm.a[AXIS_Z].travel_max,		Z_TRAVEL_MAX },
	{ "z","zjm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_Z].jerk_max,	Z_JERK_MAX },
	{ "z","zjh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_Z].jerk_homing,Z_JERK_HOMING },
	{ "z","zjd",_fip, 4, fmt_Xjd, cm_print_jd, get_flu, set_flu,(float *)&cm.a[AXIS_Z].junction_dev,	Z_JUNCTION_DEVIATION },
	{ "z","zsn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[4],				Z_SWITCH_MODE_MIN },
	{ "z","zsx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[5],				Z_SWITCH_MODE_MAX },
	{ "z","zsv",_fip, 0, fmt_Xsv, cm_print_sv, get_flu, set_flu,(float *)&cm.a[AXIS_Z].search_velocity,	Z_SEARCH_VELOCITY },
	{ "z","zlv",_fip, 0, fmt_Xlv, cm_print_lv, get_flu, set_flu,(float *)&cm.a[AXIS_Z].latch_velocity,	Z_LATCH_VELOCITY },
	{ "z","zlb",_fip, 3, fmt_Xlb, cm_print_lb, get_flu, set_flu,(float *)&cm.a[AXIS_Z].latch_backoff,	Z_LATCH_BACKOFF },
	{ "z","zzb",_fip, 3, fmt_Xzb, cm_print_zb, get_flu, set_flu,(float *)&cm.a[AXIS_Z].zero_backoff,	Z_ZERO_BACKOFF },

	{ "a","aam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_A].axis_mode,	A_AXIS_MODE },
	{ "a","avm",_fip, 0, fmt_Xvm, cm_print_vm, get_flt, set_flt,(float *)&cm.a[AXIS_A].velocity_max,	A_VELOCITY_MAX },
	{ "a","afr",_fip, 0, fmt_Xfr, cm_print_fr, get_flt, set_flt,(float *)&cm.a[AXIS_A].feedrate_max, 	A_FEEDRATE_MAX },
	{ "a","atm",_fip, 0, fmt_Xtm, cm_print_tm, get_flt, set_flt,(float *)&cm.a[AXIS_A].travel_max,		A_TRAVEL_MAX },
	{ "a","ajm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_A].jerk_max,	A_JERK_MAX },
	{ "a","ajh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_A].jerk_homing,A_JERK_HOMING },
	{ "a","ajd",_fip, 4, fmt_Xjd, cm_print_jd, get_flt, set_flt,(float *)&cm.a[AXIS_A].junction_dev,	A_JUNCTION_DEVIATION },
	{ "a","ara",_fip, 3, fmt_Xra, cm_print_ra, get_flt, set_flt,(float *)&cm.a[AXIS_A].radius,			A_RADIUS},
	{ "a","asn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[6],				A_SWITCH_MODE_MIN },
	{ "a","asx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[7],				A_SWITCH_MODE_MAX },
	{ "a","asv",_fip, 0, fmt_Xsv, cm_print_sv, get_flt, set_flt,(float *)&cm.a[AXIS_A].search_velocity,	A_SEARCH_VELOCITY },
	{ "a","alv",_fip, 0, fmt_Xlv, cm_print_lv, get_flt, set_flt,(float *)&cm.a[AXIS_A].latch_velocity,	A_LATCH_VELOCITY },
	{ "a","alb",_fip, 3, fmt_Xlb, cm_print_lb, get_flt, set_flt,(float *)&cm.a[AXIS_A].latch_backoff,	A_LATCH_BACKOFF },
	{ "a","azb",_fip, 3, fmt_Xzb, cm_print_zb, get_flt, set_flt,(float *)&cm.a[AXIS_A].zero_backoff,	A_ZERO_BACKOFF },

	{ "b","bam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_B].axis_mode,	B_AXIS_MODE },
	{ "b","bvm",_fip, 0, fmt_Xvm, cm_print_vm, get_flt, set_flt,(float *)&cm.a[AXIS_B].velocity_max,	B_VELOCITY_MAX },
	{ "b","bfr",_fip, 0, fmt_Xfr, cm_print_fr, get_flt, set_flt,(float *)&cm.a[AXIS_B].feedrate_max,	B_FEEDRATE_MAX },
	{ "b","btm",_fip, 0, fmt_Xtm, cm_print_tm, get_flt, set_flt,(float *)&cm.a[AXIS_B].travel_max,		B_TRAVEL_MAX },
	{ "b","bjm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_B].jerk_max,	B_JERK_MAX },
//	{ "b","bjh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_B].jerk_homing,B_JERK_HOMING },
	{ "b","bjd",_fip, 0, fmt_Xjd, cm_print_jd, get_flt, set_flt,(float *)&cm.a[AXIS_B].junction_dev,	B_JUNCTION_DEVIATION },
	{ "b","bra",_fip, 3, fmt_Xra, cm_print_ra, get_flt, set_flt,(float *)&cm.a[AXIS_B].radius,			B_RADIUS },
//	{ "b","asn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[6],				B_SWITCH_MODE_MIN },
//	{ "b","asx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[7],				B_SWITCH_MODE_MAX },
//	{ "b","bsv",_fip, 0, fmt_Xsv, cm_print_sv, get_flt, set_flt,(float *)&cm.a[AXIS_B].search_velocity,	B_SEARCH_VELOCITY },
//	{ "b","blv",_fip, 0, fmt_Xlv, cm_print_lv, get_flt, set_flt,(float *)&cm.a[AXIS_B].latch_velocity,	B_LATCH_VELOCITY },
//	{ "b","blb",_fip, 3, fmt_Xlb, cm_print_lb, get_flt, set_flt,(float *)&cm.a[AXIS_B].latch_backoff,	B_LATCH_BACKOFF },
//	{ "b","bzb",_fip, 3, fmt_Xzb, cm_print_zb, get_flt, set_flt,(float *)&cm.a[AXIS_B].zero_backoff,	B_ZERO_BACKOFF },

	{ "c","cam",_fip, 0, fmt_Xam, cm_print_am, cm_get_am, cm_set_am, (float *)&cm.a[AXIS_C].axis_mode,	C_AXIS_MODE },
	{ "c","cvm",_fip, 0, fmt_Xvm, cm_print_vm, get_flt, set_flt,(float *)&cm.a[AXIS_C].velocity_max,	C_VELOCITY_MAX },
	{ "c","cfr",_fip, 0, fmt_Xfr, cm_print_fr, get_flt, set_flt,(float *)&cm.a[AXIS_C].feedrate_max,	C_FEEDRATE_MAX },
	{ "c","ctm",_fip, 0, fmt_Xtm, cm_print_tm, get_flt, set_flt,(float *)&cm.a[AXIS_C].travel_max,		C_TRAVEL_MAX },
	{ "c","cjm",_fip, 0, fmt_Xjm, cm_print_jm, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_C].jerk_max,	C_JERK_MAX },
//	{ "c","cjh",_fip, 0, fmt_Xjh, cm_print_jh, cm_get_jrk, cm_set_jrk,(float *)&cm.a[AXIS_C].jerk_homing,C_JERK_HOMING },
	{ "c","cjd",_fip, 0, fmt_Xjd, cm_print_jd, get_flt, set_flt,(float *)&cm.a[AXIS_C].junction_dev,	C_JUNCTION_DEVIATION },
	{ "c","cra",_fip, 3, fmt_Xra, cm_print_ra, get_flt, set_flt,(float *)&cm.a[AXIS_C].radius,			C_RADIUS },
//	{ "c","csn",_fip, 0, fmt_Xsn, cm_print_sn, get_ui8, cm_set_sw, (float *)&sw.mode[6],				C_SWITCH_MODE_MIN },
//	{ "c","csx",_fip, 0, fmt_Xsx, cm_print_sx, get_ui8, cm_set_sw, (float *)&sw.mode[7],				C_SWITCH_MODE_MAX },
//	{ "c","csv",_fip, 0, fmt_Xsv, cm_print_sv, get_flt, set_flt,(float *)&cm.a[AXIS_C].search_velocity,	C_SEARCH_VELOCITY },
//	{ "c","clv",_fip, 0, fmt_Xlv, cm_print_lv, get_flt, set_flt,(float *)&cm.a[AXIS_C].latch_velocity,	C_LATCH_VELOCITY },
//	{ "c","clb",_fip, 3, fmt_Xlb, cm_print_lb, get_flt, set_flt,(float *)&cm.a[AXIS_C].latch_backoff,	C_LATCH_BACKOFF },
//	{ "c","czb",_fip, 3, fmt_Xzb, cm_print_zb, get_flt, set_flt,(float *)&cm.a[AXIS_C].zero_backoff,	C_ZERO_BACKOFF },

	// PWM settings
    { "p1","p1frq",_fip, 0, fmt_p1frq, pwm_print_p1frq, get_flt, set_flt,(float *)&pwm_cfg.p.frequency,	P1_PWM_FREQUENCY },
    { "p1","p1csl",_fip, 0, fmt_p1csl, pwm_print_p1csl, get_flt, set_flt,(float *)&pwm_cfg.p.cw_speed_lo,	P1_CW_SPEED_LO },
    { "p1","p1csh",_fip, 0, fmt_p1csh, pwm_print_p1csh, get_flt, set_flt,(float *)&pwm_cfg.p.cw_speed_hi,	P1_CW_SPEED_HI },
    { "p1","p1cpl",_fip, 3, fmt_p1cpl, pwm_print_p1cpl, get_flt, set_flt,(float *)&pwm_cfg.p.cw_phase_lo,	P1_CW_PHASE_LO },
    { "p1","p1cph",_fip, 3, fmt_p1cph, pwm_print_p1cph, get_flt, set_flt,(float *)&pwm_cfg.p.cw_phase_hi,	P1_CW_PHASE_HI },
    { "p1","p1wsl",_fip, 0, fmt_p1wsl, pwm_print_p1wsl, get_flt, set_flt,(float *)&pwm_cfg.p.ccw_speed_lo,P1_CCW_SPEED_LO },
    { "p1","p1wsh",_fip, 0, fmt_p1wsh, pwm_print_p1wsh, get_flt, set_flt,(float *)&pwm_cfg.p.ccw_speed_hi,P1_CCW_SPEED_HI },
    { "p1","p1wpl",_fip, 3, fmt_p1wpl, pwm_print_p1wpl, get_flt, set_flt,(float *)&pwm_cfg.p.ccw_phase_lo,P1_CCW_PHASE_LO },
    { "p1","p1wph",_fip, 3, fmt_p1wph, pwm_print_p1wph, get_flt, set_flt,(float *)&pwm_cfg.p.ccw_phase_hi,P1_CCW_PHASE_HI },
    { "p1","p1pof",_fip, 3, fmt_p1pof, pwm_print_p1pof, get_flt, set_flt,(float *)&pwm_cfg.p.phase_off,	P1_PWM_PHASE_OFF },

	// Coordinate system offsets (G54-G59 and G92)
	{ "g54","g54x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_X], G54_X_OFFSET },
	{ "g54","g54y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_Y], G54_Y_OFFSET },
	{ "g54","g54z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_Z], G54_Z_OFFSET },
	{ "g54","g54a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_A], G54_A_OFFSET },
	{ "g54","g54b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_B], G54_B_OFFSET },
	{ "g54","g54c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G54][AXIS_C], G54_C_OFFSET },

	{ "g55","g55x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_X], G55_X_OFFSET },
	{ "g55","g55y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_Y], G55_Y_OFFSET },
	{ "g55","g55z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_Z], G55_Z_OFFSET },
	{ "g55","g55a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_A], G55_A_OFFSET },
	{ "g55","g55b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_B], G55_B_OFFSET },
	{ "g55","g55c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G55][AXIS_C], G55_C_OFFSET },

	{ "g56","g56x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_X], G56_X_OFFSET },
	{ "g56","g56y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_Y], G56_Y_OFFSET },
	{ "g56","g56z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_Z], G56_Z_OFFSET },
	{ "g56","g56a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_A], G56_A_OFFSET },
	{ "g56","g56b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_B], G56_B_OFFSET },
	{ "g56","g56c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G56][AXIS_C], G56_C_OFFSET },

	{ "g57","g57x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_X], G57_X_OFFSET },
	{ "g57","g57y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_Y], G57_Y_OFFSET },
	{ "g57","g57z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_Z], G57_Z_OFFSET },
	{ "g57","g57a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_A], G57_A_OFFSET },
	{ "g57","g57b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_B], G57_B_OFFSET },
	{ "g57","g57c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G57][AXIS_C], G57_C_OFFSET },

	{ "g58","g58x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_X], G58_X_OFFSET },
	{ "g58","g58y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_Y], G58_Y_OFFSET },
	{ "g58","g58z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_Z], G58_Z_OFFSET },
	{ "g58","g58a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_A], G58_A_OFFSET },
	{ "g58","g58b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_B], G58_B_OFFSET },
	{ "g58","g58c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G58][AXIS_C], G58_C_OFFSET },

	{ "g59","g59x",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_X], G59_X_OFFSET },
	{ "g59","g59y",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_Y], G59_Y_OFFSET },
	{ "g59","g59z",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_Z], G59_Z_OFFSET },
	{ "g59","g59a",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_A], G59_A_OFFSET },
	{ "g59","g59b",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_B], G59_B_OFFSET },
	{ "g59","g59c",_fip, 3, fmt_cofs, cm_print_cofs, get_flu, set_flu,(float *)&cm.offset[G59][AXIS_C], G59_C_OFFSET },

	{ "g92","g92x",_fin, 3, fmt_cofs, cm_print_cofs, get_flu, set_nul,(float *)&gmx.origin_offset[AXIS_X], 0 },// G92 handled differently
	{ "g92","g92y",_fin, 3, fmt_cofs, cm_print_cofs, get_flu, set_nul,(float *)&gmx.origin_offset[AXIS_Y], 0 },
	{ "g92","g92z",_fin, 3, fmt_cofs, cm_print_cofs, get_flu, set_nul,(float *)&gmx.origin_offset[AXIS_Z], 0 },
	{ "g92","g92a",_fin, 3, fmt_cofs, cm_print_cofs, get_flt, set_nul,(float *)&gmx.origin_offset[AXIS_A], 0 },
	{ "g92","g92b",_fin, 3, fmt_cofs, cm_print_cofs, get_flt, set_nul,(float *)&gmx.origin_offset[AXIS_B], 0 },
	{ "g92","g92c",_fin, 3, fmt_cofs, cm_print_cofs, get_flt, set_nul,(float *)&gmx.origin_offset[AXIS_C], 0 },

	{ "g28","g28x",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g28_position[AXIS_X], 0 },// g28 handled differently
	{ "g28","g28y",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g28_position[AXIS_Y], 0 },
	{ "g28","g28z",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g28_position[AXIS_Z], 0 },
	{ "g28","g28a",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g28_position[AXIS_A], 0 },
	{ "g28","g28b",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g28_position[AXIS_B], 0 },
	{ "g28","g28c",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g28_position[AXIS_C], 0 },

	{ "g30","g30x",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g30_position[AXIS_X], 0 },// g30 handled differently
	{ "g30","g30y",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g30_position[AXIS_Y], 0 },
	{ "g30","g30z",_fin, 3, fmt_cloc, cm_print_cloc, get_flu, set_nul,(float *)&gmx.g30_position[AXIS_Z], 0 },
	{ "g30","g30a",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g30_position[AXIS_A], 0 },
	{ "g30","g30b",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g30_position[AXIS_B], 0 },
	{ "g30","g30c",_fin, 3, fmt_cloc, cm_print_cloc, get_flt, set_nul,(float *)&gmx.g30_position[AXIS_C], 0 },
...
*/
	...
	{ "sys","gpl", _f07, 0, fmt_gpl, cm_print_gpl, get_ui8, set_012, (float *)&cm.select_plane,	GCODE_DEFAULT_PLANE },
	{ "sys","gun", _f07, 0, fmt_gun, cm_print_gun, get_ui8, set_01,  (float *)&cm.units_mode,		GCODE_DEFAULT_UNITS },
	{ "sys","gco", _f07, 0, fmt_gco, cm_print_gco, get_ui8, set_ui8, (float *)&cm.coord_system,	GCODE_DEFAULT_COORD_SYSTEM },
	{ "sys","gpa", _f07, 0, fmt_gpa, cm_print_gpa, get_ui8, set_012, (float *)&cm.path_control,	GCODE_DEFAULT_PATH_CONTROL },
	{ "sys","gdi", _f07, 0, fmt_gdi, cm_print_gdi, get_ui8, set_01,  (float *)&cm.distance_mode,	GCODE_DEFAULT_DISTANCE_MODE },
