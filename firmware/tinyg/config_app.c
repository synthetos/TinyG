...
//	{ "", "sx",  _f00, 0, fmt_nul, print_nul, run_sx,  run_sx , (float *)&cs.null, 0 },					// send XOFF, XON test
	...
	// Axis parameters
	{ "x","xam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_X].axis_mode,		X_AXIS_MODE },
	{ "x","xvm",_fip, 0, fmt_Xvm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].velocity_max,	X_VELOCITY_MAX },
	{ "x","xfr",_fip, 0, fmt_Xfr, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].feedrate_max,	X_FEEDRATE_MAX },
	{ "x","xtm",_fip, 0, fmt_Xtm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].travel_max,	X_TRAVEL_MAX },
	{ "x","xjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].jerk_max,		X_JERK_MAX },
	{ "x","xjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].jerk_homing,	X_JERK_HOMING },
//	{ "x","xjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_X].jerk_max,		X_JERK_MAX },
//	{ "x","xjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_X].jerk_homing,	X_JERK_HOMING },
	{ "x","xjd",_fip, 4, fmt_Xjd, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].junction_dev,	X_JUNCTION_DEVIATION },
	...
	{ "x","xsv",_fip, 0, fmt_Xsv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].search_velocity,X_SEARCH_VELOCITY },
	{ "x","xlv",_fip, 0, fmt_Xlv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].latch_velocity,X_LATCH_VELOCITY },
	{ "x","xlb",_fip, 3, fmt_Xlb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].latch_backoff,	X_LATCH_BACKOFF },
	{ "x","xzb",_fip, 3, fmt_Xzb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_X].zero_backoff,	X_ZERO_BACKOFF },

	{ "y","yam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_Y].axis_mode,		Y_AXIS_MODE },
	{ "y","yvm",_fip, 0, fmt_Xvm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].velocity_max,	Y_VELOCITY_MAX },
	{ "y","yfr",_fip, 0, fmt_Xfr, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].feedrate_max,	Y_FEEDRATE_MAX },
	{ "y","ytm",_fip, 0, fmt_Xtm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].travel_max,	Y_TRAVEL_MAX },
	{ "y","yjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].jerk_max,		Y_JERK_MAX },
	{ "y","yjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].jerk_homing,	Y_JERK_HOMING },
//	{ "y","yjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_Y].jerk_max,		Y_JERK_MAX },
//	{ "y","yjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_Y].jerk_homing,	Y_JERK_HOMING },
	{ "y","yjd",_fip, 4, fmt_Xjd, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].junction_dev,	Y_JUNCTION_DEVIATION },
	...
	{ "y","ysv",_fip, 0, fmt_Xsv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].search_velocity,Y_SEARCH_VELOCITY },
	{ "y","ylv",_fip, 0, fmt_Xlv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].latch_velocity,Y_LATCH_VELOCITY },
	{ "y","ylb",_fip, 3, fmt_Xlb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].latch_backoff,	Y_LATCH_BACKOFF },
	{ "y","yzb",_fip, 3, fmt_Xzb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Y].zero_backoff,	Y_ZERO_BACKOFF },

	{ "z","zam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_Z].axis_mode,		Z_AXIS_MODE },
	{ "z","zvm",_fip, 0, fmt_Xvm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].velocity_max,	Z_VELOCITY_MAX },
	{ "z","zfr",_fip, 0, fmt_Xfr, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].feedrate_max,	Z_FEEDRATE_MAX },
	{ "z","ztm",_fip, 0, fmt_Xtm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].travel_max,	Z_TRAVEL_MAX },
	{ "z","zjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].jerk_max,		Z_JERK_MAX },
	{ "z","zjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].jerk_homing,	Z_JERK_HOMING },
//	{ "z","zjm",_fip, 0, fmt_Xjm, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_Z].jerk_max,		Z_JERK_MAX },
//	{ "z","zjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_Z].jerk_homing,	Z_JERK_HOMING },
	{ "z","zjd",_fip, 4, fmt_Xjd, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].junction_dev,	Z_JUNCTION_DEVIATION },
	...
	{ "z","zsv",_fip, 0, fmt_Xsv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].search_velocity,Z_SEARCH_VELOCITY },
	{ "z","zlv",_fip, 0, fmt_Xlv, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].latch_velocity,Z_LATCH_VELOCITY },
	{ "z","zlb",_fip, 3, fmt_Xlb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].latch_backoff,	Z_LATCH_BACKOFF },
	{ "z","zzb",_fip, 3, fmt_Xzb, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_Z].zero_backoff,	Z_ZERO_BACKOFF },

	{ "a","aam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_A].axis_mode,		A_AXIS_MODE },
	{ "a","avm",_fip, 0, fmt_Xvm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].velocity_max,	A_VELOCITY_MAX },
	{ "a","afr",_fip, 0, fmt_Xfr, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].feedrate_max, 	A_FEEDRATE_MAX },
	{ "a","atm",_fip, 0, fmt_Xtm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].travel_max,	A_TRAVEL_MAX },
	{ "a","ajm",_fip, 0, fmt_Xjm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].jerk_max,		A_JERK_MAX },
	{ "a","ajh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].jerk_homing,	A_JERK_HOMING },
//	{ "a","ajm",_fip, 0, fmt_Xjm, pr_ma_rot, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_A].jerk_max,		A_JERK_MAX },
//	{ "a","ajh",_fip, 0, fmt_Xjh, pr_ma_lin, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_A].jerk_homing,	A_JERK_HOMING },
	{ "a","ajd",_fip, 4, fmt_Xjd, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].junction_dev,	A_JUNCTION_DEVIATION },
	{ "a","ara",_fip, 3, fmt_Xra, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].radius,		A_RADIUS},
	...
	{ "a","asv",_fip, 0, fmt_Xsv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].search_velocity,A_SEARCH_VELOCITY },
	{ "a","alv",_fip, 0, fmt_Xlv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].latch_velocity,A_LATCH_VELOCITY },
	{ "a","alb",_fip, 3, fmt_Xlb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].latch_backoff,	A_LATCH_BACKOFF },
	{ "a","azb",_fip, 3, fmt_Xzb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_A].zero_backoff,	A_ZERO_BACKOFF },

	{ "b","bam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_B].axis_mode,		B_AXIS_MODE },
	{ "b","bvm",_fip, 0, fmt_Xvm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].velocity_max,	B_VELOCITY_MAX },
	{ "b","bfr",_fip, 0, fmt_Xfr, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].feedrate_max,	B_FEEDRATE_MAX },
	{ "b","btm",_fip, 0, fmt_Xtm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].travel_max,	B_TRAVEL_MAX },
	{ "b","bjm",_fip, 0, fmt_Xjm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].jerk_max,		B_JERK_MAX },
//	{ "b","bjm",_fip, 0, fmt_Xjm, pr_ma_rot, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_B].jerk_max,		B_JERK_MAX },
//	{ "b","bjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_B].jerk_homing,	B_JERK_HOMING },
	{ "b","bjd",_fip, 0, fmt_Xjd, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].junction_dev,	B_JUNCTION_DEVIATION },
	{ "b","bra",_fip, 3, fmt_Xra, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].radius,		B_RADIUS },
...
//	{ "b","bsv",_fip, 0, fmt_Xsv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].search_velocity,B_SEARCH_VELOCITY },
//	{ "b","blv",_fip, 0, fmt_Xlv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].latch_velocity,B_LATCH_VELOCITY },
//	{ "b","blb",_fip, 3, fmt_Xlb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].latch_backoff,	B_LATCH_BACKOFF },
//	{ "b","bzb",_fip, 3, fmt_Xzb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_B].zero_backoff,	B_ZERO_BACKOFF },

	{ "c","cam",_fip, 0, fmt_Xam, print_am,  get_am,  set_am, (float *)&cm_cfg.a[AXIS_C].axis_mode,		C_AXIS_MODE },
	{ "c","cvm",_fip, 0, fmt_Xvm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].velocity_max,	C_VELOCITY_MAX },
	{ "c","cfr",_fip, 0, fmt_Xfr, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].feedrate_max,	C_FEEDRATE_MAX },
	{ "c","ctm",_fip, 0, fmt_Xtm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].travel_max,	C_TRAVEL_MAX },
	{ "c","cjm",_fip, 0, fmt_Xjm, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].jerk_max,		C_JERK_MAX },
//	{ "c","cjm",_fip, 0, fmt_Xjm, pr_ma_rot, get_jrk, set_jrk,(float *)&cm_cfg.a[AXIS_C].jerk_max,		C_JERK_MAX },
//	{ "c","cjh",_fip, 0, fmt_Xjh, pr_ma_lin, get_flu, set_flu,(float *)&cm_cfg.a[AXIS_C].jerk_homing,	C_JERK_HOMING },
	{ "c","cjd",_fip, 0, fmt_Xjd, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].junction_dev,	C_JUNCTION_DEVIATION },
	{ "c","cra",_fip, 3, fmt_Xra, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].radius,		C_RADIUS },
...
//	{ "c","csv",_fip, 0, fmt_Xsv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].search_velocity,C_SEARCH_VELOCITY },
//	{ "c","clv",_fip, 0, fmt_Xlv, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].latch_velocity,C_LATCH_VELOCITY },
//	{ "c","clb",_fip, 3, fmt_Xlb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].latch_backoff,	C_LATCH_BACKOFF },
//	{ "c","czb",_fip, 3, fmt_Xzb, pr_ma_rot, get_flt, set_flt,(float *)&cm_cfg.a[AXIS_C].zero_backoff,	C_ZERO_BACKOFF },
	...
	{ "g54","g54y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G54][AXIS_Y], G54_Y_OFFSET },
	{ "g54","g54z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G54][AXIS_Z], G54_Z_OFFSET },
	{ "g54","g54a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G54][AXIS_A], G54_A_OFFSET },
	{ "g54","g54b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G54][AXIS_B], G54_B_OFFSET },
	{ "g54","g54c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G54][AXIS_C], G54_C_OFFSET },

	{ "g55","g55x",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_X], G55_X_OFFSET },
	{ "g55","g55y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_Y], G55_Y_OFFSET },
	{ "g55","g55z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_Z], G55_Z_OFFSET },
	{ "g55","g55a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_A], G55_A_OFFSET },
	{ "g55","g55b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_B], G55_B_OFFSET },
	{ "g55","g55c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G55][AXIS_C], G55_C_OFFSET },

	{ "g56","g56x",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_X], G56_X_OFFSET },
	{ "g56","g56y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_Y], G56_Y_OFFSET },
	{ "g56","g56z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_Z], G56_Z_OFFSET },
	{ "g56","g56a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_A], G56_A_OFFSET },
	{ "g56","g56b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_B], G56_B_OFFSET },
	{ "g56","g56c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G56][AXIS_C], G56_C_OFFSET },

	{ "g57","g57x",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_X], G57_X_OFFSET },
	{ "g57","g57y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_Y], G57_Y_OFFSET },
	{ "g57","g57z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_Z], G57_Z_OFFSET },
	{ "g57","g57a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_A], G57_A_OFFSET },
	{ "g57","g57b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_B], G57_B_OFFSET },
	{ "g57","g57c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G57][AXIS_C], G57_C_OFFSET },

	{ "g58","g58x",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_X], G58_X_OFFSET },
	{ "g58","g58y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_Y], G58_Y_OFFSET },
	{ "g58","g58z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_Z], G58_Z_OFFSET },
	{ "g58","g58a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_A], G58_A_OFFSET },
	{ "g58","g58b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_B], G58_B_OFFSET },
	{ "g58","g58c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G58][AXIS_C], G58_C_OFFSET },

	{ "g59","g59x",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_X], G59_X_OFFSET },
	{ "g59","g59y",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_Y], G59_Y_OFFSET },
	{ "g59","g59z",_fip, 3, fmt_cofs, print_coor, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_Z], G59_Z_OFFSET },
	{ "g59","g59a",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_A], G59_A_OFFSET },
	{ "g59","g59b",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_B], G59_B_OFFSET },
	{ "g59","g59c",_fip, 3, fmt_cofs, print_corr, get_flu, set_flu,(float *)&cm_cfg.offset[G59][AXIS_C], G59_C_OFFSET },
	...
	// System parameters
	{ "sys","ja",  _f07, 0, fmt_ja, print_lin, get_flu, set_flu, (float *)&cm_cfg.junction_acceleration,JUNCTION_ACCELERATION },
	{ "sys","ct",  _f07, 4, fmt_ct, print_lin, get_flu, set_flu, (float *)&cm_cfg.chordal_tolerance,	CHORDAL_TOLERANCE },
...
*/
	...
	{ "sys","gpl", _f07, 0, fmt_gpl, print_ui8, get_ui8, set_012, (float *)&cm_cfg.select_plane,		GCODE_DEFAULT_PLANE },
	{ "sys","gun", _f07, 0, fmt_gun, print_ui8, get_ui8, set_01,  (float *)&cm_cfg.units_mode,			GCODE_DEFAULT_UNITS },
	{ "sys","gco", _f07, 0, fmt_gco, print_ui8, get_ui8, set_ui8, (float *)&cm_cfg.coord_system,		GCODE_DEFAULT_COORD_SYSTEM },
	{ "sys","gpa", _f07, 0, fmt_gpa, print_ui8, get_ui8, set_012, (float *)&cm_cfg.path_control,		GCODE_DEFAULT_PATH_CONTROL },
	{ "sys","gdi", _f07, 0, fmt_gdi, print_ui8, get_ui8, set_01,  (float *)&cm_cfg.distance_mode,		GCODE_DEFAULT_DISTANCE_MODE },
	...
	{ "",   "ms",  _fip, 0, fmt_ms, print_lin, get_flt, set_flt, (float *)&cm_cfg.estd_segment_usec,	NOM_SEGMENT_USEC },
	{ "",   "ml",  _fip, 4, fmt_ml, print_lin, get_flu, set_flu, (float *)&cm_cfg.min_segment_len,		MIN_LINE_LENGTH },
	{ "",   "ma",  _fip, 4, fmt_ma, print_lin, get_flu, set_flu, (float *)&cm_cfg.arc_segment_len,		ARC_SEGMENT_LENGTH },
