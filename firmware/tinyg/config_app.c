...
//	{ "jog","jogc",_f0, 0, tx_print_nul, get_nul, cm_run_jogc, (uint32_t *)&cm.jogging_dest, 0},    // FYI
	...
	{ "x","xsn",_fip,  0, cm_print_sn, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[0].mode,					X_SWITCH_MODE_MIN },
	{ "x","xsx",_fip,  0, cm_print_sx, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[1].mode,					X_SWITCH_MODE_MAX },
	...
	{ "y","ysn",_fip,  0, cm_print_sn, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[2].mode,					Y_SWITCH_MODE_MIN },
	{ "y","ysx",_fip,  0, cm_print_sx, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[3].mode,					Y_SWITCH_MODE_MAX },
	...
	{ "z","zsn",_fip,  0, cm_print_sn, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[4].mode,					Z_SWITCH_MODE_MIN },
	{ "z","zsx",_fip,  0, cm_print_sx, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[5].mode,					Z_SWITCH_MODE_MAX },
	...
	{ "a","asn",_fip,  0, cm_print_sn, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[6].mode,					A_SWITCH_MODE_MIN },
	{ "a","asx",_fip,  0, cm_print_sx, get_ui8,   sw_set_sw, (uint32_t *)&sw.s[7].mode,					A_SWITCH_MODE_MAX },
