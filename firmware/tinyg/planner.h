...
enum trapezoidReturnCode {
	...
	TRAPEZOID_HT_SYMMETRIC_HEAD_VIOLATION,
	TRAPEZOID_HT_SYMMETRIC_TAIL_VIOLATION,
	TRAPEZOID_HT_SYMMETRIC_OK,

	TRAPEZOID_HT_ASYMMETRIC_HEAD_VIOLATION,
	TRAPEZOID_HT_ASYMMETRIC_HEAD_ONLY,
	TRAPEZOID_HT_ASYMMETRIC_TAIL_VIOLATION,
