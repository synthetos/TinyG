...
<<<<<<< HEAD
//#define TINYG_FIRMWARE_BUILD   		409.31	// cleanup, ready for more extensive testing
=======
#define TINYG_FIRMWARE_BUILD   		409.33	// added DDA accumulator compensation for non-uniform segment timings
>>>>>>> synthetos/dev
