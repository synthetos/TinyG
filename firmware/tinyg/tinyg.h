...
#define TINYG_FIRMWARE_BUILD   		405.14	// comparing jerk-based exec to forward diff based exec
...
//#define __ALT_SEGMENTS			// uncomment to use rounded segment counts instead of ceiling truncated
