...
#define XOFF_RX_HI_WATER_MARK (RX_BUFFER_SIZE * 0.9)	// % to issue XOFF
#define XOFF_RX_LO_WATER_MARK (RX_BUFFER_SIZE * 0.1)	// % to release XOFF
#define XOFF_TX_HI_WATER_MARK (RX_BUFFER_SIZE * 0.9)	// % to issue XOFF
#define XOFF_TX_LO_WATER_MARK (RX_BUFFER_SIZE * 0.05)	// % to release XOFF
